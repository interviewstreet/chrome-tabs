...
(function() {
  ...
  chromeTabs = {
    ...
    setStyle: function($shell) {
      if (document.body.style['-webkit-mask-repeat'] !== void 0) {
        ...
        if ($shell.data().style === "firefox") {
          ...
          return $shell.addClass("no-cssmasks");
        } else {
          $shell.removeClass("no-cssmasks");
          return $shell.addClass("cssmasks");
        }
      } else {
        return $shell.addClass('no-cssmasks');
      }
    ...
    setupEvents: function($shell) {
      ...
      return $shell.find('.chrome-tab').each((function(_this) {
    ...
    addNewTab: function($shell, newTabData) {
      var $newTab, key, ref, tabData, value;
      $newTab = $(tabTemplate);
      if ($shell.data().noClose) {
